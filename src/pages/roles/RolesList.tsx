...
const AVAILABLE_PERMISSIONS: Permission[] = [
    { id: 'users.read', name: 'View Users', description: 'Can view users list and details', module: 'Users' },
    { id: 'users.write', name: 'Manage Users', description: 'Can create, update and delete users', module: 'Users' },
    { id: 'restaurants.read', name: 'View Restaurants', description: 'Can view restaurants', module: 'Restaurants' },
    { id: 'restaurants.write', name: 'Manage Restaurants', description: 'Can manage restaurants', module: 'Restaurants' },
    { id: 'promotions.read', name: 'View Promotions', description: 'Can view promotions', module: 'Promotions' },
    { id: 'promotions.write', name: 'Manage Promotions', description: 'Can manage promotions', module: 'Promotions' },
    { id: 'ingredients.read', name: 'View Ingredients', description: 'Can view ingredients', module: 'Ingredients' },
    { id: 'ingredients.write', name: 'Manage Ingredients', description: 'Can manage ingredients', module: 'Ingredients' },
];
...
const MOCK_ROLES: Role[] = [
    ...
    },
    {
        id: '2',
        name: 'Manager',
        description: 'Can manage restaurants and promotions',
        permissions: ['restaurants.read', 'restaurants.write', 'promotions.read', 'promotions.write'],
        usersCount: 5
    },
    {
        id: '3',
        ...
        permissions: ['users.read', 'restaurants.read', 'promotions.read', 'ingredients.read'],
        usersCount: 12
    }
];
